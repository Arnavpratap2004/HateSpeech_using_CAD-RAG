...
# src/rag/engine.py -> src/rag -> src -> root
PROJECT_ROOT = os.path.dirname(os.path.dirname(os.path.dirname(os.path.abspath(__file__))))
SCRIPT_DIR = PROJECT_ROOT # Keep alias for compatibility in this script
...
test_file_path = os.path.join(PROJECT_ROOT, 'data', 'raw', 'train_test.csv')
